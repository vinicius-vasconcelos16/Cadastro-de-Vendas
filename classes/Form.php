    ...
    class Form {
      ...
      public static function alert($tipo, $mensagem){
       if($tipo == 'Erro'){
        ...
        public static function cadastrar($tipo_do_pagamento,$data,$nome_do_item,$quantidade,$valor,$observacoes){
          $sql = Mysql::conectar()->prepare("INSERT INTO `formulario` VALUES (null,?,?,?,?,?,?)");
          $sql->execute(array($tipo_do_pagamento,$data,$nome_do_item,$quantidade,$valor,$observacoes));
        }
    }
