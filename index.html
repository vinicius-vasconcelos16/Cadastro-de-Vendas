...
<head>
  ...
  <body>
    ...
    <div> 
      <ul id="menu-h">
        <li><a>Cadastro de Vendas</a></li><li><a href="consulta.php">Consultar</a></li>
      </ul>
    </div> 
    <!--Fim do Menu-->
    ...
    <div class="form_pg"> <!--Inicio da tela de cadastro-->
      ...
      <?php 
            ...
            if(isset($_POST['acao']) && $_POST['form'] == 'f_form'){
                ...
                if($tipo_do_pagamento == ''){
                  ...
                  Form::cadastrar($tipo_do_pagamento,$data,$nome_do_item,$quantidade,$valor,$observacoes);
      ...
      <form method="POST"> <!--Inicio da box de cadastramento-->
        ...
        <div class="form_iten"><strong><label>Produto </label></strong><input type="text" name="iten" placeholder="Nome do Produto">
